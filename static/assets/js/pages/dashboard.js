 ...
 *
 *  Demo analis configuration. Contains charts and plugin inits
 *
 *  Version: 1.0
...
$(function() {    
    ...
    function salesHeatmap() {
        ...
        d3.csv("assets/demo_data/analis/app_sales_heatmap.csv", function(error, data) {
    ...
    function bulletChart(element, height) {
        ...
        d3.json("assets/demo_data/analis/bullets.json", function(error, data) {
